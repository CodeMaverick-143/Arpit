// Reusable SVG icon components — no emojis anywhere
...
export function TerminalSquareIcon({ size = 18, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function PenToolIcon({ size = 18, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function KaggleIcon({ size = 18, className = '' }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M18.825 2.388V17.5a.64.64 0 0 1-.502.627l-5.111 2.213a.6.6 0 0 1-.502-.452l-1.353-8.85s-2.008 1.832-2.008 1.832v7.126a.64.64 0 0 1-.502.627l-5.111 2.213a.6.6 0 0 1-.502-.452V2.388a.64.64 0 0 1 .502-.627L8.85 3.974a.6.6 0 0 1 .502.452v8.948l1.353-8.948a.6.6 0 0 1 .502-.452l5.111-2.213a.64.64 0 0 1 .502.627z"/>
    </svg>
  );
}
